...
def dense_flow(fm):
    ...
    while True:
        ...
        if ret:
            ...
            magnitude_histogram10, direction_histogram10 = create_hist_context(magnitude10, direction10, magnitude_histogram10, direction_histogram10)
            magnitude_histogram11, direction_histogram11 = create_hist_context(magnitude11, direction11, magnitude_histogram11, direction_histogram11)
            magnitude_histogram12, direction_histogram12 = create_hist_context(magnitude12, direction12, magnitude_histogram12, direction_histogram12)
            magnitude_histogram13, direction_histogram13 = create_hist_context(magnitude13, direction13, magnitude_histogram13, direction_histogram13)
            magnitude_histogram14, direction_histogram14 = create_hist_context(magnitude14, direction14, magnitude_histogram14, direction_histogram14)
            magnitude_histogram15, direction_histogram15 = create_hist_context(magnitude15, direction15, magnitude_histogram15, direction_histogram15)
            magnitude_histogram16, direction_histogram16 = create_hist_context(magnitude16, direction16, magnitude_histogram16, direction_histogram16)
